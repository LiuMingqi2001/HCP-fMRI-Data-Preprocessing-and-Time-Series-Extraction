...
#     print(f'Register for: {subject_name}')
...
#             for phase in [1, 2]:
#                 # Construct the paths for fMRI data
...
#                 os.system(
#                     f'wb_command -cifti-separate {fMRI_data} COLUMN -volume-all {fMRI_data_dir}/rfMRI_REST{phase}_{direction}.nii.gz'
#                 )
#
#                 # Apply warp
#                 warped_output = os.path.join(fMRI_data_dir, 'Atlas_in_T1w_all.nii.gz')
#                 warp_cmd = (
#                     f'applywarp --ref=/home/test/lmq/data/HCP/{subject_name}/T1/T1_3mm.nii.gz '
#                     f'--in={fMRI_data_dir}/rfMRI_REST{phase}_{direction}.nii.gz '
#                     f'--warp=/home/test/lmq/data/HCP/{subject_name}/{subject_name}_3T_Structural_preproc/{subject_name}/MNINonLinear/xfms/standard2acpc_dc.nii.gz '
#                     f'--out={warped_output}'
#                 )
#                 os.system(warp_cmd)
#
#                 # Split the warped file into volumes
#                 os.system(f'fslsplit {warped_output} {fMRI_data_dir}/volume_ -t')
#
...
#                     os.system(
#                         f'flirt -ref {vol_path} -in {vol_path} -o {downsampled_vol} -applyisoxfm 3 -interp nearestneighbour'
#                     )
#
...
#                 os.system(f'fslmerge -t {merged_output} {downsampled_volumes}')
#
